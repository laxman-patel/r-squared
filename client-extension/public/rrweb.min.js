    ...
    for (var n = 50, r = 0; r < t.width; r += n)
      for (var o = 0; o < t.height; o += n) {
        var a = e.getImageData,
          s = Dt in a ? a[Dt] : a,
          i = new Uint32Array(
            s.call(e, r, o, Math.min(n, t.width - r), Math.min(n, t.height - o))
              .data.buffer,
          );
        if (
          i.some(function (l) {
    ...
    return class Zn extends t {
      ...
      appendChild(n) {
        ...
        if (
          ...
          throw new Error(
            `RRDomException: Failed to execute 'appendChild' on 'RRNode': Only one ${r === R.Element ? "RRElement" : "RRDoctype"} on RRDocument allowed.`,
          );
        return (
      ...
      insertBefore(n, r) {
        ...
        if (
          ...
          throw new Error(
            `RRDomException: Failed to execute 'insertBefore' on 'RRNode': Only one ${o === R.Element ? "RRElement" : "RRDoctype"} on RRDocument allowed.`,
          );
  ...
  function Mn(t, e, n, r, o) {
    ...
    for (; s <= i && l <= c; ) {
      ...
      if (u === void 0) u = t[++s];
        ...
        (de(u, h, r, o), (u = t[++s]), (h = e[++l]));
      else if (f !== -1 && f === g)
        (de(d, p, r, o), (d = t[--i]), (p = e[--c]));
      else if (S !== -1 && S === g)
